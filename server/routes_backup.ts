...
import { sendEmail } from './services/workingEmailService';
import { generateFormEmailHTML, generateFormEmailText } from './utils/emailTemplates';
    ...
    try {
      ...
      try {
        await sendEmail({
          ...
          subject: `Daily Sales & Stock Report - ${data.shift_time || new Date().toLocaleDateString()}`,
          html: generateFormEmailHTML(data),
          text: generateFormEmailText(data)
        });
