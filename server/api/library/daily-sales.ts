  ...
  try {
    ...
    for (const salesRecord of salesRows) {
      ...
      unifiedData.push({
        ...
        startingCash: parseFloat(salesRecord.startingCash?.toString() ?? '0'),
        closingCash: parseFloat(salesRecord.endingCash?.toString() ?? '0'),
        totalSales: parseFloat(salesRecord.totalSales?.toString() ?? '0'),
        totalExpenses: parseFloat(salesRecord.totalExpenses?.toString() ?? '0'),
        bankCash: parseFloat(salesRecord.cashBanked?.toString() ?? '0'),
        bankQr: parseFloat(salesRecord.qrSales?.toString() ?? '0'),
