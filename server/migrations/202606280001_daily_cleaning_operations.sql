...
VALUES
  ('clean_daily_kitchen_floors', 'kitchen-floors', 'Kitchen Floors', '["Swept","Mopped","No food debris","No grease","No standing water"]'::jsonb, 'daily_cleaning', 'cleaning', 'daily', 10),
  ('clean_daily_food_prep', 'food-preparation-area', 'Food Preparation Area', '["Prep benches sanitised","Meat prep area cleaned","Food contact surfaces sanitised","No food residue"]'::jsonb, 'daily_cleaning', 'cleaning', 'daily', 20),
  ('clean_daily_grill_fryer', 'grill-fryer-station', 'Grill & Fryer Station', '["Grill chemically cleaned","Fryer exterior cleaned","Splashbacks cleaned","Cooking line grease free"]'::jsonb, 'daily_cleaning', 'cleaning', 'daily', 30),
  ('clean_daily_customer_area', 'customer-area', 'Customer Area', '["Tables clean","Front counter clean","Customer area clean","Floor free of rubbish"]'::jsonb, 'daily_cleaning', 'cleaning', 'daily', 40),
  ('clean_daily_waste_washing', 'waste-washing-area', 'Waste & Washing Area', '["Bins emptied","Bins cleaned","Washing area clean","Equipment washed and stored"]'::jsonb, 'daily_cleaning', 'cleaning', 'daily', 50)
