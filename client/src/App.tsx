...
import AnalysisV2 from "./pages/analysis/AnalysisV2";
import AnalysisV3 from "./pages/analysis/AnalysisV3";
          ...
          <BrowserRouter>
            ...
            <Routes>
              ...
              <Route element={<PageShell />}>
                ...
                <Route path="/analysis/v2" element={<ProtectedRoute><AnalysisV2 /></ProtectedRoute>} />
                <Route path="/analysis/v3" element={<ProtectedRoute><AnalysisV3 /></ProtectedRoute>} />
