...
export default function AdminQrCodes() {
  ...
  const tab: "venues" | "members" = requestedTab === "members" ? "members" : "venues";

  const setTab = (nextTab: "venues" | "members") => {
    ...
    <main className="min-h-full bg-neutral-50">
      <div className="mx-auto max-w-7xl px-4 pt-4 md:px-6 md:pt-6">
        <div className="inline-flex rounded-xl border border-neutral-200 bg-white p-1 shadow-sm">
          <button onClick={() => setTab("venues")} className={`rounded-lg px-4 py-2 text-sm font-semibold ${tab === "venues" ? "bg-neutral-950 text-white" : "text-neutral-600"}`}>Partner Venues & QR</button>
