...
export default function PosRegister() {
  ...
  return <main className="h-dvh overflow-hidden bg-[#fffdf4] text-[#171717]">
    <header className="flex h-[70px] items-center justify-between bg-[#111111] px-5 text-white shadow-lg">
      <div className="flex items-center gap-3"><div className="grid h-10 w-10 place-items-center rounded-2xl bg-[#ffd400] text-sm font-black text-black">SB</div><div><b className="block text-sm tracking-[0.12em] text-[#ffd400]">SMASH BROTHERS</b><span className="text-xs text-zinc-400">Rawai · Register 1</span></div><nav className="ml-5 hidden gap-1 lg:flex"><span className="rounded-xl bg-white/10 px-4 py-2 text-sm font-semibold">New order</span><a href="/pos/kitchen" className="rounded-xl px-4 py-2 text-sm text-zinc-300 hover:bg-white/10">Kitchen</a><a href="/pos/display" className="rounded-xl px-4 py-2 text-sm text-zinc-300 hover:bg-white/10">Ticket display</a><a href="/pos/shifts" className="rounded-xl px-4 py-2 text-sm text-zinc-300 hover:bg-white/10">Shift</a></nav></div>
