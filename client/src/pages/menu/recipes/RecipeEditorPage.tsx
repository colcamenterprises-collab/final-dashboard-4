...
export default function RecipeEditorPage() {
  ...
  const costRows = useMemo(() => ingredients.map((row) => { const unitCost = toNumber(row.manualOverrideUnitCost) ?? toNumber(row.autoUnitCost); const qty = toNumber(row.quantityUsed); return { row, unitCost, qty, lineCost: unitCost !== null && qty !== null ? unitCost * qty : null }; }), [ingredients]);
