        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span className="px-2 py-1 rounded bg-blue-100 text-blue-700 text-xs">
              Thresholds: Sales ±{THRESHOLDS.sales} | Expenses ±{THRESHOLDS.expenses} | Banking ±{THRESHOLDS.banking}
            </span>
          </div>
        </div>
              ...
              <tbody>
                <tr className="border-b border-slate-100 hover:bg-slate-50">
                  ...
                  <td className="px-4 py-2 text-center">
                    <Flag val={v.sales.cash} limit={THRESHOLDS.sales} />
                  </td>
                </tr>
                <tr className="border-b border-slate-100 hover:bg-slate-50">
                  ...
                  <td className="px-4 py-2 text-center">
                    <Flag val={v.sales.qr} limit={THRESHOLDS.sales} />
                  </td>
                </tr>
                <tr className="border-b border-slate-100 hover:bg-slate-50">
                  ...
                  <td className="px-4 py-2 text-center">
                    <Flag val={v.sales.grab} limit={THRESHOLDS.sales} />
                  </td>
                </tr>
                <tr className="bg-slate-100 border-t-2 border-slate-300 font-semibold">
                  ...
                  <td className="px-4 py-2 text-center">
                    <Flag val={v.sales.total} limit={THRESHOLDS.sales} />
                  </td>
                </tr>
              </tbody>
            </table>
            ...
            <table className="w-full text-xs">
              ...
              <tbody>
                <tr className="border-b border-slate-100 hover:bg-slate-50">
                  ...
                  <td className="px-4 py-2 text-center">
                    <Flag val={v.expenses.shoppingTotal} limit={THRESHOLDS.expenses} />
                  </td>
                </tr>
                <tr className="border-b border-slate-100 hover:bg-slate-50">
                  ...
                  <td className="px-4 py-2 text-center">
                    <Flag val={v.expenses.wageTotal} limit={THRESHOLDS.expenses} />
                  </td>
                </tr>
                <tr className="bg-slate-100 border-t-2 border-slate-300 font-semibold">
                  ...
                  <td className="px-4 py-2 text-center">
                    <Flag val={v.expenses.grandTotal} limit={THRESHOLDS.expenses} />
                  </td>
                </tr>
              </tbody>
            </table>
            ...
            <table className="w-full text-xs">
              ...
              <tbody>
                <tr className="border-b border-slate-100 hover:bg-slate-50">
                  ...
                  <td className="px-4 py-2 text-center">
                    <Flag val={v.banking.expectedCash} limit={THRESHOLDS.banking} />
                  </td>
                </tr>
                <tr className="border-b border-slate-100 hover:bg-slate-50">
                  ...
                  <td className="px-4 py-2 text-center">
                    <Flag val={v.banking.estimatedNetBanked} limit={THRESHOLDS.banking} />
                  </td>
                </tr>
              </tbody>
            </table>
