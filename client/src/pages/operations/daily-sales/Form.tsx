...
const labels = {
  en: {
    ...
    pageSubtitle: 'Step 1 of 3 — complete Sales & Expenses, then you\'ll be redirected to Daily Cleaning.',
    ...
    formStock: 'Daily Cleaning',
    inSeconds: 'in',
    seconds: 'sec…',
    goToStock: 'Go to Daily Cleaning now',
    stayHere: 'Stay here',
  ...
  th: {
    ...
    pageSubtitle: 'ขั้นตอนที่ 1 จาก 3 — กรอกยอดขายและค่าใช้จ่าย จากนั้นจะไปยังหน้าทำความสะอาดประจำวัน',
    ...
    formStock: 'การทำความสะอาดประจำวัน',
    inSeconds: 'ใน',
    seconds: 'วินาที…',
    goToStock: 'ไปหน้าทำความสะอาดประจำวันเลย',
    stayHere: 'อยู่ที่นี่',
