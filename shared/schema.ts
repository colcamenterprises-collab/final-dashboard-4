...
export const dailySalesV2 = pgTable("daily_sales_v2", {
  ...
  grabReceiptCount: integer("grab_receipt_count").notNull().default(0),
  cashReceiptCount: integer("cash_receipt_count").notNull().default(0),
  qrReceiptCount: integer("qr_receipt_count").notNull().default(0),
...
export const product = pgTable("product", {
  ...
  priceInStore: numeric("price_in_store", { precision: 10, scale: 2 }),
  priceOnline: numeric("price_online", { precision: 10, scale: 2 }),
  priceGrab: numeric("price_grab", { precision: 10, scale: 2 }),
  category: text("category"),
