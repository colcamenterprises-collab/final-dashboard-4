...
export const dailyStockSales = pgTable('daily_stock_sales', {
  ...
  foodpandaSales: decimal('foodpandaSales', { precision: 10, scale: 2 }).default('0'),
  walkInSales: decimal('walkInSales', { precision: 10, scale: 2 }).default('0'),
  ...
  // Food category fields - simplified structure with additional items
  fresh: jsonb('fresh'),
  frozen: jsonb('frozen'),
  shelf: jsonb('shelf'),
  kitchen: jsonb('kitchen'),
  packaging: jsonb('packaging'),
  // Cash and notes
  endingCash: decimal('endingCash', { precision: 10, scale: 2 }).default('0'),
  notes: text('notes'),
